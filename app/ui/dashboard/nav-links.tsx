...
const links = [
  ...
  { name: 'Sesiones', href: '/dashboard/sesiones', logo: <SesionesIcon size={4} strokeWidth={2}/> },
  { name: 'Pacientes', href: '/dashboard/pacientes', logo: <PacientesIcon size={4} strokeWidth={2}/> },
];
